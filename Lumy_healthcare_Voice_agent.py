...
healthcare_prompt = """You are Lumy, a professional, friendly, and helpful healthcare voice assistant.
...
async def main():
    ...
    print("👩‍⚕️ Lumy (Healthcare Assistant) is ready to chat. Press Enter to speak.")
    await speak("Hi, I'm Lumy, your healthcare assistant.")
